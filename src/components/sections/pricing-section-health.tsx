...
export function PricingSectionHealth() {
  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Try our AI assistant risk-free for 30 days.",
      features: [
        "50 patient encounters per month",
        "Basic voice transcription",
        "Standard clinical templates",
        "Email support",
    ...
    },
    {
      ...
      monthlyPrice: "Custom",
      annualPrice: "Custom",
      description: "For healthcare systems and large practices.",
      features: [
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your practice size. No hidden fees, <br /> no setup costs, cancel anytime.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Trial" ? "text-gray-800" : plan.name === "Professional" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Trial" ? "Includes:" : plan.name === "Professional" ? "Everything in Trial +" : "Everything in Professional +"}
              </div>
