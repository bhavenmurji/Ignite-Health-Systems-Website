    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 429) {
          ...
          throw new Error('Failed to submit form. Please check your information and try again.')
        }
      }
      ...
      const errorMessage = error instanceof Error ? error.message : 'There was an error submitting your information. Please try again.'
