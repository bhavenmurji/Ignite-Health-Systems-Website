  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for solo practitioners exploring AI assistance.",
      features: [
        "Basic clinical documentation automation",
        "Up to 50 patient encounters per month",
    ...
    },
    {
      ...
      monthlyPrice: "$299",
      annualPrice: "$249",
      description: "The full clinical automation experience.",
      features: [
        ...
        "Pajama time reduction guarantee",
    ...
    },
    {
      ...
      monthlyPrice: "$999",
      annualPrice: "$799",
      description: "Complete practice management for multi-physician groups.",
      features: [
        "Everything in Clinical Co-Pilot",
