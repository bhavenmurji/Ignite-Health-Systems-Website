...
export function BentoSectionHealth() {
  const cards = [
    ...
    },
    {
      ...
      description: "Integrated Member App, training-free Staff Tools, and real-time Business Insights.",
      Component: RealtimeCodingPreviews,
    },
    {
      title: "Universal Integration",
      description: "Seamless connectivity with labs, pharmacies, and specialty systems in one unified hub.",
      Component: OneClickIntegrationsIllustration,
    },
    {
      title: "Beyond Traditional Medicine",
      description: "Solving operational challenges for chiropractic, veterinary, dental, and therapy practices.",
      Component: MCPConnectivityIllustration,
    },
    {
      title: "The 10-Minute Revolution",
      description: "Save 10+ minutes per encounter, nearly two full work weeks every month.",
      Component: ParallelCodingAgents,
    },
    {
      title: "Physician-Built Trust",
      description: "Created by physicians who understand the real challenges of clinical practice.",
